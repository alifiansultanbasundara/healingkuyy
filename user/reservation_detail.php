<?php
// File: user/reservation_detail.php
...
$stmt = $pdo->prepare("
    SELECT r.*, s.name as service_name, s.location, s.description as service_description, s.price as service_price,
           h.name as hotel_name, h.description as hotel_description, h.price_per_night, h.image as hotel_image,
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <?php if ($reservation['status'] == 'pending' || $reservation['status'] == 'confirmed'): ?>
                                <?php if (!$cancellation): ?>
                                    <a href="cancellation.php?reservation_id=<?php echo $reservation['id']; ?>" class="btn btn-danger">
                            ...
                            <?php if ($reservation['status'] == 'confirmed'): ?>
                                <a href="checkin.php" class="btn btn-success">
                                    <i class="fas fa-check-circle me-1"></i> Check-in Online
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
